...
public:
    ...
    double iterations_per_second() const { return (_total_time > 0) ? ((double)_total_iterations / (double)_total_time): 0; }
    double items_per_second() const { return (_total_time > 0) ? ((double)_total_items / (double)_total_time): 0; }
    double bytes_per_second() const { return (_total_time > 0) ? ((double)_total_bytes / (double)_total_time): 0; }
